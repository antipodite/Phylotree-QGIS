...
from .phylo_tree_algorithm import PhyloTreeAlgorithm


class PhyloTreeProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(PhyloTreeAlgorithm())
